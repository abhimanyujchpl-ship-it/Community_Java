        ...
        {!loading && community ? (
          <View className="gap-4">
            ...
            <PrimaryButton
              ...
              onPress={async () => {
                try {
                  const approvedCommunity = await communityService.dashboard(community.id);
                  setActiveCommunity(approvedCommunity);
                  router.push({ pathname: "/community/dashboard", params: { communityId: community.id } });
                } catch {
                  router.push({ pathname: "/community/access-request", params: { communityId: community.id } });
                }
              }}
            />
          </View>
