...
public record CreateCommunityRequest(
        ...
        @NotBlank(message = "City is required") @Size(max = 120, message = "City must be 120 characters or fewer") String city,
        @NotBlank(message = "State is required") @Size(max = 120, message = "State must be 120 characters or fewer") String state
) {
}
